...
app.controller("TronController", function($http, $scope, $rootScope){
    ...
    imageBike.src = "resources/images/bike_empty_v2.png";
    var imageShield = new Image();
    imageShield.src = "resources/images/shield_v2.png";
        ...
        if(gameInitialized) {
            ...
            for (var player in playersInfos) {
                if(playersInfos[player].alive == true) {
                    ...
                    context.fillRect(-4, -15, 8, 8);
                    context.fillRect(-2, -4, 4, 11);
                    context.fillRect(-4, 7, 8, 8);
                    context.drawImage(imageBike, -6, -15);

                    // Invincibilité
                    if (playersInfos[player].invincibility > 0) {
                        context.drawImage(imageShield, -17, -17);
                    }
