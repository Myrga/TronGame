			...
			<script type="text/ng-template" id="tron.html">
				<section id="jeu">
					...
					<section>
						...
						<button id="respawnButton" type="button" ng-click="tronCtrl.respawn()" ng-show="!tronCtrl.playersInfos[tronCtrl.playerId].alive && keys(tronCtrl.playersInfos).length == 1">Réapparaître (R)</button>
					</section>
				</section>
			</script>
		</main>
